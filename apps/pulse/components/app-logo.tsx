  ...
  return (
    <div className={cn('flex min-w-0 items-center gap-3', className)}>
      <span className={cn('relative block size-8 shrink-0 overflow-hidden', iconClassName)}>
        <img alt='' aria-hidden='true' className='block size-full dark:hidden' src='/logos/pulse-light.svg' />
        <img alt='' aria-hidden='true' className='hidden size-full dark:block' src='/logos/pulse-dark.svg' />
      </span>
