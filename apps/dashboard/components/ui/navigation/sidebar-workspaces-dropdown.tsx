...
const getWorkspaceAvatarSeed = (workspace: (typeof workspaces)[number]) => workspace.value;
      ...
      <DropdownMenuTrigger
        ...
        render={
          <button
            type='button'
            className={cn(
              'group flex w-full items-center gap-x-3 rounded-2xl px-3 py-3 text-sm font-medium text-foreground transition hover:bg-muted data-open:bg-muted',
              focusRing
            )}
          >
            <DashboardAvatar
            ...
            <div className='flex w-full items-center justify-between gap-x-4 truncate'>
              <div className='truncate'>
                ...
                <p className='text-left text-xs whitespace-nowrap text-muted-foreground'>{selectedWorkspace.role}</p>
              </div>
