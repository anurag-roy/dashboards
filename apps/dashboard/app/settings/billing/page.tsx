              ...
              <div className='md:col-span-2'>
                <div className='flex items-center justify-between'>
                  <div className='flex items-center gap-4'>
                    <ProgressCircle value={isSpendMgmtEnabled ? 62.2 : 0} radius={20} strokeWidth={4.5} />
                    <div>
                      {isSpendMgmtEnabled ? (
                        <>
                          <p className='text-sm font-medium text-foreground'>&#36;280 / 350 (62.2&#37;)</p>
                ...
                >
                  <div
                    className={cn(
                      'transition',
                      isSpendMgmtEnabled ? 'animate-in duration-300 fade-in-0 slide-in-from-top-2' : 'hidden'
                    )}
                    style={{
                  ...
                  >
                    <div className='mt-8 grid grid-cols-1 gap-4 md:grid-cols-3'>
                      <div className='md:col-span-1'>
                        ...
                        <Input id='hard-cap' name='hard-cap' defaultValue={350} type='number' className='mt-2' />
                      </div>
                      <div className='md:col-span-2'>
                        <Label className='font-medium'>Provide email for notifications</Label>
                        <Input id='email' name='email' placeholder='admin@company.com' type='email' className='mt-2' />
                      </div>
                    </div>
                ...
                <Card className='overflow-hidden p-0'>
                  <div className='px-4 pt-4 pb-6'>
                    ...
                    <p className='mt-2 max-w-xl text-sm leading-6 text-muted-foreground'>
                      Safeguard your assets with our cutting-edge bot protection. Our AI solution identifies and
                      mitigates automated traffic to protect your workspace from bad bots.
                    </p>
                  </div>
