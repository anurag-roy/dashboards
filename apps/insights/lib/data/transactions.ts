...
// Keep dataset deterministic so SSR/CSR don't drift and charts stay stable.
const baseDate = new Date('2026-04-25T12:00:00.000Z');
...
for (let dayIndex = 0; dayIndex < 210; dayIndex += 1) {
...
export const transactions: Transaction[] = generatedTransactions.sort((a, b) =>
