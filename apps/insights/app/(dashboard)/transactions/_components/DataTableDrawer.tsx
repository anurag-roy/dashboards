                  ...
                  <div className='grid grid-cols-1 gap-4 sm:grid-cols-2'>
                    <div className='space-y-2'>
                      ...
                      <Select
                        ...
                        onValueChange={(value) => {
                          if (value) {
                            setExpenseStatus(value as Transaction['expense_status']);
                          }
                        }}
                      >
                    ...
                    <div className='space-y-2'>
                      ...
                      <Select
                        ...
                        onValueChange={(value) => {
                          if (value) {
                            setPaymentStatus(value as Transaction['payment_status']);
                          }
                        }}
                      >
                  ...
                  <div className='grid grid-cols-1 gap-4 sm:grid-cols-2'>
                    ...
                    <div className='space-y-2'>
                      ...
                      <Select
                        ...
                        onValueChange={(value) => {
                          if (value) {
                            setReimbursementType(value as (typeof reimbursementItems)[number]['value']);
                          }
                        }}
                      >
