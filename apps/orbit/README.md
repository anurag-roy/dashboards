...
This document explains how the `apps/orbit` app is structured, what each route renders, and which components/patterns are used so another agent can onboard quickly.

## Purpose

- A usage analytics dashboard UI migrated to the monorepo stack (`Next.js 16`, `React 19`, `Tailwind v4`).
...
- Static app branding: `components/app-logo.tsx` rendered in the sidebar header and mobile top bar.
