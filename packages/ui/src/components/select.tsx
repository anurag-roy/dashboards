...
function SelectGroup({ className, ...props }: SelectPrimitive.Group.Props) {
  return <SelectPrimitive.Group data-slot='select-group' className={cn('scroll-my-1.5', className)} {...props} />;
}
...
function SelectScrollUpButton({ className, ...props }: React.ComponentProps<typeof SelectPrimitive.ScrollUpArrow>) {
  return (
    <SelectPrimitive.ScrollUpArrow
      ...
      className={cn(
        "top-0 z-20 flex w-full cursor-default items-center justify-center border-b border-border/60 bg-popover py-1 text-popover-foreground supports-[backdrop-filter]:bg-popover/95 supports-[backdrop-filter]:backdrop-blur-sm [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4",
        className
      )}
      {...props}
    >
      <ChevronUpIcon className='size-4 text-popover-foreground' />
    </SelectPrimitive.ScrollUpArrow>
  );
}
...
function SelectScrollDownButton({ className, ...props }: React.ComponentProps<typeof SelectPrimitive.ScrollDownArrow>) {
  return (
    <SelectPrimitive.ScrollDownArrow
      ...
      className={cn(
        "bottom-0 z-20 flex w-full cursor-default items-center justify-center border-t border-border/60 bg-popover py-1 text-popover-foreground supports-[backdrop-filter]:bg-popover/95 supports-[backdrop-filter]:backdrop-blur-sm [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4",
        className
      )}
      {...props}
    >
